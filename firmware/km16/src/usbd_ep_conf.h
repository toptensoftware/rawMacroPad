...
/* Custom HID (Raw HID) Endpoints Configurations */
...
#ifdef USBD_USE_CUSTOM_HID
  #define PMA_CUSTOMHID_IN_ADDR   (PMA_EP0_IN_ADDR + USB_MAX_EP0_SIZE)
  #define PMA_CUSTOMHID_OUT_ADDR  (PMA_CUSTOMHID_IN_ADDR + CUSTOM_HID_EPIN_SIZE)
#endif /* USBD_USE_CUSTOM_HID */
